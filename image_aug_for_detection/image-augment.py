...
import cv2
import numpy as np
imageDir=r"E:\pycharm_project\image_aug_for_detection\myfile\myaugment\images"     #要改变的图片的路径文件夹
saveDir=r"E:\pycharm_project\image_aug_for_detection\data\augmented"   #要保存的图片的路径文件夹
