...
# 1.标签路径
csv_file = r"E:\pycharm_project\image_aug_for_detection\myfile\myaugment\csv_files\augmented_labels.txt"
saved_path = r"E:\data\1228-dj/VOC1029/"  # 保存路径
image_save_path = "JPEGImages/"
image_raw_parh = r"E:\pycharm_project\image_aug_for_detection\myfile\myaugment\augment_images/"
# 2.创建要求文件夹
