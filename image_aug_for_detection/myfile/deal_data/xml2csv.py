...
def convert_voc_annotation(data_path, data_type, anno_path, use_difficult_bbox=True):
    ...
    image_inds = [x.split('.')[0] for x in os.listdir(data_path+'images')]
    print(len(image_inds),image_inds)
    # exit()
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="E:\pycharm_project\image_aug_for_detection\myfile\myaugment/")
